...
export function Footer() {
  ...
  return (
    <footer className="px-5 2xl:px-64 py-5 flex justify-between md:items-center dark:bg-slate-900 dark:text-slate-50 flex-col items-start gap-5 md:flex-row bg-slate-200">
      <div>
